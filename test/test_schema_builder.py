...
# @pg.foreign_key(name='t6_field_1_fk', references=_test_table5,
#                 columns=('field_1', 'field_2', ), referenced_columns=('field_3', 'field_4', ))
...
# @pg.serial(column='field_1', sequence=_test_table6_id_seq)
...
#         'ALTER TABLE "_test"."_test_table4" ALTER COLUMN "field_2" DROP NOT NULL'])
# 
#     def mod_generator_3() -> Generator[bd.SQLSentenceParams, None, None]:
#         yield from bd.builder(_test)\
