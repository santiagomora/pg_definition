#ifndef TEST_APP_DATABASE_DEFINITIONS
#define TEST_APP_DATABASE_DEFINITIONS
...
#define TEST_APP_COMPOSITE_AUTHOR_MEMBERS T_MEMBERS(TEST_APP_COMPOSITE_AUTHOR)
