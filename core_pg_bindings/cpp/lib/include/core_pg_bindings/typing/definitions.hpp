...
#define PG_BOOLEAN PG_TYPE_DOMAIN(\
    PG_BOOLEAN,\
...
#define PG_FLOAT4 PG_TYPE_DOMAIN(\
    PG_FLOAT4,\
...
#define PG_FLOAT8 PG_TYPE_DOMAIN(\
    PG_FLOAT8,\
...
#define PG_TIMESTAMPTZ PG_TYPE_DOMAIN(\
    PG_TIMESTAMPTZ,\
